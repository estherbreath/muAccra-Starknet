...
mod Airdrop {
    ...
    impl AirdropImpl of IAirdrop<ContractState> {
        fn register(ref self: ContractState) {// TODO: check ICO has not ended
        // TODO: check user is not already registered
        // TODO: transfer REGPRICE from caller to this contract
        }

        fn claim(ref self: ContractState, address: ContractAddress) {// TODO: check that user is registered
